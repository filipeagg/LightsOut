...
```yaml
id: acmeerp-core          # must equal the directory name
name: Acmeerp core
kind: technical           # technical | functional | organisational | market | other
description: How the Acmeerp core is structured and what its invariants are.
tags: [erp, agro, legacy, sql-server]
owner: felipe.gomes@acme.com
updated: 2026-07-25
```
...
```yaml
id: acmeerp-docs
name: Acmeerp documentation
kind: technical
source: docs/acmeerp          # relative to the workspace root; the folder stays the source of truth
```
...
```
--- knowledge: acmeerp-core (technical) — data-model.md ---
```
