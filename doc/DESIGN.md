...
options ACMEPRODUCT has, it answered from a project's source code (`acmeproduct-map-poc`), while
`knowledge/acme/acmeproduct/producto/Estructura_Menu_ACMEPRODUCT.md` held the answer. A generic bullet
