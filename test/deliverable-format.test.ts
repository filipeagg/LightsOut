...
f.1.claim: base acmeproduct holds 38 undocumented fields
f.1.kind: preference
...
describe("what the check applies to (BA-07, §20.2)", () => {
  ...
  it("measures our own Markdown deliverables, including one in a knowledge base", () => {
    ...
    expect(deliverablePath(workspace, project, "workspace:knowledge/acmeproduct/index.md")).toBe(
      "/workspace/knowledge/acmeproduct/index.md",
    );
  });
